        ...
        for(int i = 1; i<N_pad-1; i++){
            for(int j = 1; j<N_pad-1; j++){
                ...
                coarse_grid[i * N_pad + j] = 
                    ( 
                    1 * fine_grid[conv_3d(M, a-1,b-1,c-1)]
                    + 2 * fine_grid[conv_3d(M,a,b-1,c-1)]
                    + 1 * fine_grid[conv_3d(M,a+1,b-1,c-1)] 
                    + 2 * fine_grid[conv_3d(M,a-1,b,c-1)] 
                    + 4 * fine_grid[conv_3d(M,a,b,c-1)]
                    + 2 * fine_grid[conv_3d(M,a+1,b,c-1)]
                    + fine_grid[conv_3d(M,a-1,b+1,c-1)]
                    + 2* fine_grid[conv_3d(M,a,b+1,c-1)]
                    + fine_grid[conv_3d(M,a+1,b+1,c-1)]

                    + 2 * fine_grid[conv_3d(M,a-1,b-1,c)]
                    + 4 * fine_grid[conv_3d(M,a,b-1,c)]
                    + 2 * fine_grid[conv_3d(M,a+1,b-1,c)] 
                    + 4 * fine_grid[conv_3d(M,a-1,b,c)] 
                    + 8 * fine_grid[conv_3d(M,a,b,c)]
                    + 4 * fine_grid[conv_3d(M,a+1,b,c)]
                    + 2 * fine_grid[conv_3d(M,a-1,b+1,c)]
                    + 4 * fine_grid[conv_3d(M,a,b+1,c)]
                    + 2 * fine_grid[conv_3d(M,a+1,b+1,c)]
