...
void test_richardson_smoothing(){
    printf("Testing Richardson smoothing - START \n");

    printf("TC1 - Convergences with only Richardson\n");
    int N = 5;
    int vec_size = (N+2)*(N+2);
    ...
    printf("Testing Richardson smoothing - END \n\n");
}
